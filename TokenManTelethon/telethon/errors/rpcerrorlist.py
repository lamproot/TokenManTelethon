...
class ChatNotModifiedError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__("The chat or channel wasn't modified (title, invites, username, admins, etc. are the same)")
...
class InputRequestTooLongError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('The input request was too long. This may be a bug in the library as it can occur when serializing more bytes than it should (like appending the vector constructor code at the end of a message)')
...
class ReplyMarkupTooLongError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('The data embedded in the reply markup buttons was too much')
...
class TakeoutRequiredError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('You must initialize a takeout request first')
...
class UrlInvalidError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__("The URL used was invalid (e.g. when answering a callback with an URL that's not t.me/yourbot or your game's URL)")
...
class UserNotParticipantError(BadRequestError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('The target user is not a member of the specified megagroup or channel')
...
class AuthKeyDuplicatedError(AuthKeyError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('An auth key with the same ID was already generated')


class PhoneNumberInvalidError(AuthKeyError):
    def __init__(self, **kwargs):
        super(Exception, self).__init__('The phone number is invalid')
