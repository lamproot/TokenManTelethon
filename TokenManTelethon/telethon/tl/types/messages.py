...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChatFull, TypeFoundGif, TypeStickerPack, TypeDocument, TypeDialog, TypeStickerSet, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeHighScore, TypeChat, TypeEncryptedFile, TypeUser, TypeStickerSetCovered, TypeMessage
