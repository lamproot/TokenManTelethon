...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeTopPeerCategoryPeers, TypeContactBlocked, TypeImportedContact, TypeContactLink, TypeChat, TypeUser, TypeContact, TypePeer, TypePopularContact
