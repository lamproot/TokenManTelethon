...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeBool, TypeChannelBannedRights, TypeInputStickerSet, TypeChannelAdminRights, TypeInputChannel, TypeInputMessage, TypeInputUser
