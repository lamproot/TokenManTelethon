...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeShippingOption, TypeInputChatPhoto, TypeInputGeoPoint, TypeMessagesFilter, TypeReplyMarkup, TypeInputDialogPeer, TypeInputSingleMedia, TypeInputPeer, TypeInlineBotSwitchPM, TypeSendMessageAction, TypeInputUser, TypeInputDocument, TypeInputMedia, TypeInputStickeredMedia, TypeInputStickerSet, TypeMessageEntity, TypeInputBotInlineResult, TypeInputEncryptedFile, TypeBool, TypeInputBotInlineMessageID, TypeInputEncryptedChat, TypeInputMessage, TypeReportReason
