...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeBool, TypeInputSecureValue, TypeSecureValueType, TypeInputPeer, TypeInputPrivacyRule, TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeSecureValueHash, TypeInputPrivacyKey, TypeSecureCredentialsEncrypted, TypeReportReason
