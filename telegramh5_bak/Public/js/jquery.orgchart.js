  ...
  function createNode(nodeData, opts) {
    ...
    if(nodeData[opts.is_null] == "true"){
      ...
      var $nodeDiv = $('<div class="onclickhref" data-uid="'+nodeData[opts.nodeUid]+'">', {'id': nodeData[opts.nodeId]})
        ...
        .append(typeof opts.nodeAchievement !== 'undefined' ? '<div class="content">总:' + nodeData[opts.nodeAchievement]['left']/10000 +"  "+ nodeData[opts.nodeAchievement]['middle']/10000 +"  "+ nodeData[opts.nodeAchievement]['right']/10000 +'</div>' : '')
        .append(typeof opts.nodeSurplus !== 'undefined' ? '<div class="content">新:' + nodeData[opts.nodeSurplus]['left']/10000 + "  " + nodeData[opts.nodeSurplus]['middle']/10000 + "  " + nodeData[opts.nodeSurplus]['right']/10000 + '</div>' : '');
