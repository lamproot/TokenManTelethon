                ...
                <div class="ibox-content table-responsive">
                    <div class="row">
                        <div class="col-sm-12 m-b-xs">
							<p>
                                <a type="button" class="btn btn-w-m btn-danger" href="__APP__/ChatCommand/add?chat_id=<?php echo ($_GET['chat_id']); ?>">新增</a>
                        ...
                        <table class="table table-hover no-margins table-bordered table-striped">
                            ...
                            <tbody>
                                <?php if(is_array($result['result'])): foreach($result['result'] as $key=>$data): ?><tr>
                                        ...
                                        <td><?php echo ($data["id"]); ?></span></td>
    									<td><?php echo ($data["cmd"]); ?></td>
                                        <td><?php echo ($data["type"]); ?></td>
										<td style="width:200px;word-wrap：break-word"><?php echo ($data["content"]); ?></td>
    									<td ><?php echo (date("Y-m-d H:i:s",$data["created_at"])); ?></td>

                                        <td>
    										<a href="__APP__/ChatCommand/edit/id/<?php echo ($data["id"]); ?>?chat_id=<?php echo ($_GET['chat_id']); ?>">编辑</a>
    										<a href="__APP__/ChatCommand/delete/id/<?php echo ($data["id"]); ?>?chat_id=<?php echo ($_GET['chat_id']); ?>" onclick="return confirm('确认删除吗？')">删除</a>
