                ...
                <div class="ibox-content">
					<form class="form-horizontal m-t" id="signupForm" method="post" action="__ACTION__">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="token" name="token" value="<?php echo ($result['token']); ?>" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input id="name" name="name" value="<?php echo ($result['name']); ?>" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
							</div>
						</div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">chat_id:</label>
                            <div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input id="master_id" name="master_id" value="<?php echo ($result['master_id']); ?>" class="form-control" type="text" value="">
							</div>
						</div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-6">
								<input id="code_cmd" name="code_cmd" value="<?php echo ($result['code_cmd']); ?>" class="form-control" type="text" value="">
							</div>
						</div>
