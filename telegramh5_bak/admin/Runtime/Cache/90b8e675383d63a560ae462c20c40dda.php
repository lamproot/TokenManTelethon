                    ...
                    <div class="row">
                        <div class="col-sm-4 m-b-xs">
							<p>
								...
								<a type="button" href="__APP__/Download/codes/chat_id/<?php echo ($_GET['chat_id']); ?>?star=<?php echo ($_GET['start']); ?>&stop=<?php echo ($_GET['stop']); ?>" class="btn btn-w-m btn-danger">导出用户数据</a>
						...
						<div class="col-sm-8 text-right">
	                            ...
	                            <form role="form" class="form-inline" action="" method="get">
	                                <div class="form-group ">
	                                    <input type="start" name="start" placeholder="开始时间" class="form_datetime form-control" data-date="" data-date-format="yyyy-mm-dd" value="<?php echo ($_GET['start']); ?>">
	                                </div>

	                                <div class="form-group">
	                                    <input type="stop" name="stop" placeholder="结束时间" class="form_datetime form-control" data-date="" data-date-format="yyyy-mm-dd" value="<?php echo ($_GET['stop']); ?>">
	                                </div>
                        ...
                        <table class="table table-hover no-margins table-bordered table-striped">
                            ...
                            <tbody>
                                <?php if(is_array($result['result'])): foreach($result['result'] as $key=>$data): ?><tr>
										...
										<td><?php echo ($data["invited"]); ?></td>
                                        <td><?php echo ($data["eth"]); ?></td>
										<td><?php echo ($data["code"]); ?></td>
                                        <td>
    										<a target="_blank" href="__APP__/Codes/user/chat_id/<?php echo ($_GET['chat_id']); ?>?parent_code=<?php echo ($data["code"]); ?>">查看邀请用户</a>
