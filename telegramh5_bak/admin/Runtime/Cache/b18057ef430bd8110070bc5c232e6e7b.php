                ...
                <div class="ibox-content">
					<form class="form-horizontal m-t" id="signupForm" method="post" action="__ACTION__">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">*cmd:</label>
                            <div class="col-sm-6">
                                <input id="cmd" name="cmd" value="<?php echo ($result['cmd']); ?>" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="content" rows="8" cols="80" id="content" name="content" class="form-control" aria-required="true" aria-invalid="true" class="error"><?php echo ($result['content']); ?></textarea>
