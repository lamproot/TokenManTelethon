    ...
    <body style="font-size: 24px;" duitang_screen_capture_injected="true">
        <div class="container">
            <form class="row">
                ...
                <div class="col-sm-12 text-center">
                    <a href="<?php echo ($group_activity['join_button_url']); ?>" class="join border-radius" style="text-decoration:none;"><?php echo ($group_activity['join_button_text']); ?></a></div>
                <div class="col-sm-12 text-center">
                    <p class="desc"><?php echo ($group_activity['message']); ?></p>
                    <!--<p class="desc">每邀请一个好友加入，你将额外获得 <strong style="font-size: 1.5em">388</strong> 个 SSS，邀请越多，奖励越多，赶快行动!</p>--></div>
                <div class="col-sm-12 text-center">
                    <input name="wallet" class="address border-radius text-center" placeholder="请输入你的 ETH 钱包地址">
                    <input type="hidden" name="code" value="">
                    <input type="hidden" name="middletoken" value="2bffdd208ab079be9d741b7cc856b367"></div>
                <div class="col-sm-12 text-center">
                ...
                <div class="col-sm-12 text-center link-box">
                    <a class="link" href="<?php echo ($group_activity['bottom_text_url']); ?>"><?php echo ($group_activity['bottom_text']); ?></a></div>
            </form>
        </div>
        ...
        <script>$(function() {
                $('.submit').click(function() {
                    ...
                    $.ajax({
                        ...
                        if (res && res.success) {
                            window.location.href = '/dashboard/?code=' + res.code;
                        } else {
                            if (ladda) {
                                ladda.stop();
                            }
