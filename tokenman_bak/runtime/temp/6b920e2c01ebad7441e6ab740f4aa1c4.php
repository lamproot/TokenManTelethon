                    ...
                    <div class="col-lg-4">
                        <div class="box box-danger">
                            <div class="box-header">
                                <h3 class="box-title"><?php echo __('Novice guidance'); ?></h3>
                                <div class="box-tools pull-right">
                                    <a href="" target="_blank" class="btn btn-box-tool"><?php echo __('More'); ?></a>
                                </div>
                            </div>
...
<script id="newstpl" type="text/html">
    <ul class="nav nav-stacked">
        ...
        <li>
            <a href="<%=item.url%>">
                <?php if(isset($_COOKIE['think_var']) && $_COOKIE['think_var'] == 'en'): ?>
                    <span class="text"><%=item.en_title%></span>
                <?php else: ?>
...
<script id="discussiontpl" type="text/html">
    <ul class="products-list product-list-in-box">
        ...
        <li class="item">
            <div class="">
                <a href="<%=item.url%>" class="product-title"><%=item.title%>
