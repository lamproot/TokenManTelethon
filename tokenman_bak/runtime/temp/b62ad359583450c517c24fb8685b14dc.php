            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <div class="btn-group">
                            <a href="#" class="btn btn-info btn-switch active" data-url="<?php echo $config['fastadmin']['api_url']; ?>/addon/index"><i class="fa fa-cloud"></i> <?php echo __('Online store'); ?></a>
                            <a href="#" class="btn btn-info btn-switch" data-url="addon/downloaded"><i class="fa fa-laptop"></i> <?php echo __('Local addon'); ?></a>
                        </div>
