<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:95:"/Library/WebServer/documents/www/lua/tokenman/public/../application/admin/view/index/index.html";i:1521019244;s:85:"/Library/WebServer/documents/www/lua/tokenman/application/admin/view/common/meta.html";i:1521019244;s:87:"/Library/WebServer/documents/www/lua/tokenman/application/admin/view/common/header.html";i:1521019244;s:85:"/Library/WebServer/documents/www/lua/tokenman/application/admin/view/common/menu.html";i:1523863076;s:88:"/Library/WebServer/documents/www/lua/tokenman/application/admin/view/common/control.html";i:1521019244;s:87:"/Library/WebServer/documents/www/lua/tokenman/application/admin/view/common/script.html";i:1521019244;}*/ ?>
<!DOCTYPE html>
                    ...
                    <li class="user-body">
                        <div class="row">
                            <div class="col-xs-4 text-center">
                                <a href="http://www.fastadmin.net" target="_blank"><?php echo __('FastAdmin'); ?></a>
                            </div>
                            <div class="col-xs-4 text-center">
                                <a href="http://forum.fastadmin.net" target="_blank"><?php echo __('Forum'); ?></a>
                            </div>
                            <div class="col-xs-4 text-center">
                                <a href="http://doc.fastadmin.net" target="_blank"><?php echo __('Docs'); ?></a>
                            </div>
                        </div>
                    </li>
                    <!-- Menu Footer-->
...
<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li data-rel="external"><a href="" target="_blank"><i class="fa fa-qq text-aqua"></i> <span><?php echo __('QQ chat'); ?></span></a></li>
        <li data-rel="external"><a href="" target="_blank"><i class="fa fa-envelope-o text-aqua"></i> <span><?php echo __('Telegram chat'); ?></span></a></li>
        <li data-rel="external"><a href="" target="_blank"><i class="fa fa-envelope-o text-aqua"></i> <span><?php echo __('Email'); ?></span></a></li>
